	...
	this.grid = {
		init: function() {
			...
			this.gridQuickSearchField = new Ext.form.TriggerField({
				...
				triggerClass: 'x-form-clear-trigger', hideTrigger: true, style: 'height:24px;margin-top:3px;margin-bottom:2px;',
				listeners: {
			...
			this.panel = new FR.components.Grid({
				tbar: {
					items: [this.actions.add, this.actions.edit, this.actions.view, this.actions.openWebLink, this.actions.search, this.actions.loginAs, this.actions.viewLog, '->', this.actions.deActivate, this.actions.del, this.actions.archiveLogs, this.gridQuickSearchField],
					enableOverflow: true
				}
			});
		},
