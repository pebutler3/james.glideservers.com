	...
	items: [
		...
		},
		{
			...
			items: [
				{xtype:'hidden'},
				{
					xtype: 'button', text: FR.T('Select all'), cls:'fr-btn-smaller fr-btn-nomargin', handler: function() {Ext.each(FR.logSearch.actionsList, function(c) {c.setValue(true);});}
				},
				{
					xtype: 'button', text: FR.T('Clear all'), cls:'fr-btn-smaller fr-btn-nomargin', handler: function() {Ext.each(FR.logSearch.actionsList, function(c) {c.setValue(false);});}
				}
			]
		},
		{
