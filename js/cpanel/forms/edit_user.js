								...
								items : [
									{
										xtype: 'textfield',
										name: 'pwd',
										width: 165, value: '-no-pass-change-',
										inputType: 'password',
										listeners: {
											change: function() {
												Ext.getCmp('notifyPassChange').show();
					...
					},
					{
						...
						items: [
							...
							},
							{
								...
								items: [
									{xtype: 'button', text: FR.T('Check path'), cls:'fr-btn-default fr-btn-smaller', handler: function() {
			...
			},
			{
				...
				items: [
					{xtype: 'panel',layout: 'form', border: false, items: [{
						...
						fieldLabel: FR.T('User group(s)'), tcfg: {height: 150, width: 230}
					}]}
				]
			},
			{
